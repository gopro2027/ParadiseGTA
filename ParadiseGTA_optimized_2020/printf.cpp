#define PRINTFDEBUG 1         //KEEP THIS SET TO 1. SMALL BUGS OCCUR WHEN IT IS NOT ENABLED
//#define DEBUG_FILE
//#ifdef DEBUG
/*
	...
	while (ch != '\0')
		...
		case PRINT_S_CONV:
			...
			case 'u':
				...
				break;
			/*case 'f':
				floatvalue = va_arg(args, float);
				//char num[10];
				//snprintf(num, sizeof(num), "%.2f", floatvalue);
				strvalue = FtoS(floatvalue);
...
//define snprintf to use the gta snprintf
...
//int std::printf(const char *fmt, ...) {return 0;}
//int printf(const char *fmt, ...) {return 0;}
//#define unsigned int size_t
//int snprintf(char *buffer, int len, const char *fmt, ...){return 0;}
