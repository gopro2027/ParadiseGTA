...
cd %UserProfile%\ps3tools\ps3tools\tools\scetool\
echo scetool path is %UserProfile%\ps3tools\ps3tools\tools\scetool\
...
echo **COMPLETED** DEX/CEX/HEX sprx is located at %~dp0ParadiseGTA.sprx
